...
var canvasLabel;
var chordLabel;
var chordNamesMaj = ["C", "D flat", "D", "E flat", "E", "F", "F sharp", "G", "A flat", "A", "B flat", "B"];
var chordNamesMin = ["C", "C sharp", "D", "E flat", "E", "F", "F sharp", "G", "G sharp", "A", "B flat", "B"];
var chordNamesDim = ["C", "C sharp", "D", "D sharp", "E", "F", "F sharp", "G", "G sharp", "A", "A sharp", "B"];
var chordNamesAug = ["C", "D flat", "D", "E flat"];
  ...
  if (!keyIsPressed) {
    ...
    if (selectedNode != undefined) {
      ...
      if (i < 12) {
        ...
        i2 = i1 + 3;
        i3 = i1 + 6;
        chordLabel.html(chordNamesDim[i1] + " diminished");
      } else if (i < 24) {
        // moll
        i1 = i - 12;
        i2 = i1 + 3;
        i3 = i1 + 7;
        chordLabel.html(chordNamesMin[i1] + " minor");
      } else if (i < 36) {
        // Dur
        i1 = i - 24;
        i2 = i1 + 4;
        i3 = i1 + 7;
        chordLabel.html(chordNamesMaj[i1] + " major");
      } else {
        // aug
        i1 = i - 36;
        i2 = i1 + 4;
        i3 = i1 + 8;
        chordLabel.html(chordNamesAug[i1] + " augmented");
      }
...
function createTrackpads() {
  canvasLabel = createDiv("Drag up/down to zoom");
  canvasLabel.elt.style.width = "200px";
  canvasLabel.elt.style.height = "30px";
  canvasLabel.elt.style.left = "5px";
  ...
  chordLabel.elt.style.top = "5px";
  chordLabel.elt.style.backgroundColor = "#0000";
  chordLabel.elt.style.color = "#000";
  chordLabel.elt.style.fontWeight = "bold";
  chordLabel.elt.style.textAlign = "right";
...
function updateLayout() {
  ...
  chordLabel.elt.style.left = (cw - 200 + margin) + "px";
